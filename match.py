...
if "최근상대전적" in selected_stats:
    if not recent_data.empty:
        ...
        def highlight_larger(row):
            ...
            if col3 > col5:
                styles[1] = 'color: lightblue; font-weight: bold;'  # 2번째 열을 강조
                styles[2] = 'color: lightblue; font-weight: bold;'  # 3번째 열을 강조
            elif col5 > col3:
                styles[4] = 'color: lightblue; font-weight: bold;'  # 5번째 열을 강조
                styles[5] = 'color: lightblue; font-weight: bold;'  # 6번째 열을 강조
            elif col3 == col5:
